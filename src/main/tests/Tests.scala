  ...
  "User" can{
    "input incorrect command" in{
      assertResult(errString) {
        ParserCommands.parseLine("")
        ParserCommands.parseLine("/LMAO")
        ParserCommands.parseLine("/create_pool Test")
        ParserCommands.parseLine("/delete 1")
        ParserCommands.parseLine("/start 1")
        ParserCommands.parseLine("/stop 2")
